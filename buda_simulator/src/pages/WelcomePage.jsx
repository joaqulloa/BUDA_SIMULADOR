...
const WelcomePage = () => {
  ...
  useEffect(() => {
    ...
    axios.get(`https://buda-simulator-server.onrender.com/consultar-precios?mes_inicial=${mes_inicial_}&mes_final=${mes_final_}`)
      .then(response => {
  ...
  return (
    <section>
        ...
        <div className='flex flex-1 md:flex-row flex-col'>
          ...
          <div className='flex-1 ml-5 xs:w-full w-[90%]'>
